...
Try this guide in skill network by clicking https://ide.skillsnetwork.site/quicklab/{projectid}[Cloud hosted guide^].

Try this guide in staging skill network by clicking https://labs.cognitiveclass.ai/tools/theiadocker/lab/tree?md_instructions_url=https://cf-course-data-staging.s3.us-east.cloud-object-storage.appdomain.cloud/acknowledging-messages-using-microprofile-reactive-messaging/instructions.md[Cloud hosted guide^].
